...
/*
  ...
  * @param  GPIOx where x can be (A..D) to select the GPIO peripheral for CS32L010 device
  * @param  GPIO_Init 结构体
  * @retval None
  */
...
/*
  * @brief  切换指定的GPIO引脚 Toggles the specified GPIO pin
  * @param  GPIOx: where x can be (A..D depending on device used) to select the GPIO peripheral
